...
function showRiddle() {
  ...
  */
  ...
  newA.textContent = 'Answer: ' + answer;
  newA.setAttribute('id','riddle-answer')
  newA.hidden = true;
...
function revealAnswers() {
    const ridContainer = document.querySelector('.riddle-content');
    const riddle = ridContainer.querySelector('p');
